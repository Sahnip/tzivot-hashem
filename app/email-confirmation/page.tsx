    ...
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-b from-background to-muted/40 px-4 py-8">
      <Card className="w-full max-w-2xl border-primary/20 shadow-xl">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="liquid-glassspace-y-3">
            <p className="text-sm font-medium text-foreground mb-5">Accéder à ma messagerie</p>
            <div className="grid gap-3 sm:grid-cols-2">
              {providers.map((provider) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="liquid-glass group flex items-center justify-between border bg-background p-3 transition hover:border-primary hover:bg-accent"
                >
